...
module.exports = require('./MapStore2/build/buildConfig')({
    bundles: {
        'Routing': path.join(__dirname, "js", "app"),
        'Routing-embedded': path.join(__dirname, "js", "embedded"),
        'Routing-api': path.join(__dirname, "MapStore2", "web", "client", "product", "api"),
